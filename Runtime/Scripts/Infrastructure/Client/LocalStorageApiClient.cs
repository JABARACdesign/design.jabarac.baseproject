    ...
    public class LocalStorageApiClient : ILocalStorageApiClient
    {
            ...
            where TEnum : struct, Enum
        {
            ...
            try
            {
                ...
                return new APIResponse<Texture2D>(status: APIDefinition.Code.Success, data: texture, errorMessage: null);
            }
            catch (Exception e)
            {
                return new APIResponse<Texture2D>(
        ...
        where TEnum : struct, Enum
        {
            try
            {
                ...
                return new APIResponse(status: APIDefinition.Code.Success, errorMessage: null);
            }
            catch (Exception e)
            {
